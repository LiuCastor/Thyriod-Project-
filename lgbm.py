...
def evaluate_model(model, x_test, y_test, model_name):
    ...
    # lgbm - Accuracy: 0.7360, Precision: 0.7401, Recall: 0.7360, F1: 0.7369,        Log Loss: 0.5405, Error Rate: 0.2640, Specificity: 0.7360
    ...
    try:
        ...
        #xgb
        shap.summary_plot(shap_values, X_test_df)  # 使用 Explanation 对象
        # After checking all features，we only need one figure for estimation and comparison
